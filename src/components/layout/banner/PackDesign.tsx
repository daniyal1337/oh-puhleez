...
import package5 from "public/images/service/package5.png";

import package2 from "public/images/service/package2.jpg";
import package3 from "public/images/service/package3.jpg";
          ...
          <div className="row gaper align-items-center">
            <div className="col-12 col-lg-5 col-xl-7">
              <div className="text-center text-lg-start">
                <h2 className="title title-anim">Package Design</h2>
                    ...
                    <div className="row gaper">
                      <div className="col-12 col-lg-7">
                        <div className="details-group">
                          ...
                          <p>According to branding and marketing experts, the value of a company’s goods and services are measured by presentation of the brand. In other words, consumers will judge the value of your business by how they perceive your brand.</p>
                        </div>
                      </div>
...
7. Customer persona development <br />
8. Logo design <br />
9. Brochure and stationery design <br />
