          ...
          <div className="row gaper align-items-center">
            ...
            <div className="col-12 col-lg-7 col-xl-5">
              <div className="text-center text-lg-start">
                ...
                We are digital creative agency in Delhi Ranks No.1 Globally on Google for “Online Branding Solutions”. We form a reliable alliance with our Partners and make sure to identify loops and gaps and fill them with recommended branding measures.
                </p>
              </div>
            </div>
          </div>
